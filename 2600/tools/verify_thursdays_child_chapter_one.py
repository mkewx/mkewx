...
# Banks 3-6 preserve the approved terrain/color pages. Their $F600 object art
# and $F700 service schedules are deliberately stage-authored in this build.
# Major Tom copies also differ from the old checkpoint because that checkpoint
# placed them three bytes before the canonical pointer.
if len(sys.argv) == 4:
    ...
    for bank in range(3, 7):
        for page in range(0x800, 0xC00, 0x100):
...
print(
    ...
    "presentation RESET recovery; fixed gameplay bank calls; approved terrain "
    "preservation; stage-authored object pages; canonical Major Tom art; "
